        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <input type="tel" name="contact" placeholder="xxxxxxxxxxx" class="input-responsive" required>

                    <div class="order-label">Email</div>
                    <input type="email" name="email" placeholder="***@gmail.com" class="input-responsive" required>

                    <div class="order-label">Address</div>
                    <textarea name="address" rows="10" placeholder="location, city, country" class="input-responsive" required></textarea>
            ...
            <?php 
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    if($res2==true)
                    {
                        ...
                        $_SESSION['order'] = "<div class='success text-center'> Order Confirmed Successfully.</div>";
                        header('location:'.SITEURL);
                    }
                    else
                    {
